...
| Library | License | Purpose | URL |
|---------|---------|---------|-----|
| SymPy | BSD-3-Clause | Symbolic math (optional) | https://sympy.org |
...
| ModernGL | MIT | OpenGL rendering | https://github.com/moderngl/moderngl |
| pyrr | MIT | 3D math (matrices, quaternions) | https://github.com/adamlwgriffiths/Pyrr |
...
| GLFW | zlib | Windowing | https://www.glfw.org |
| glad | MIT/Public Domain | OpenGL loader | https://glad.dav1d.de |
